...
from models.helpers import onehot, sigmoid
...
class MLP:
    ...
    def forward(self, x): 
        ...
        # Hidden Layer
        # input dimension: [n_examples, n_features] dot [n_hidden, n_features].T
        ...
        # Output Layer
        # input dimension: [n_examples, n_hidden] dot [n_classes, n_hidden].T
    ...
    def backward(self, x, a_h, a_out, y):
        ...
        # one-hot encoding
        y_one_hot = onehot(y, self.num_classes)

        # Step 1:
        # dLoss/dOutWeights = dLoss/dOutAct * dOutAct/dOutNet * dOutNet/dOutWeight
        # where deltaOut = dLoss/dOutAct * dOutAct/dOutNet

        # Input/Output dimensions: [n_examples, n_classes]
        d_loss__d_a_out = 2.*(a_out - y_one_hot) / y.shape[0]
        ...
        # Output dimensions: [n_hidden, n_features]
